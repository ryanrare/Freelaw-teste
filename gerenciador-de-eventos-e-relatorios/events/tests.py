...
class EventDetailPutViewTestCase(APITestCase):
    ...
    def test_put_event(self):
        ...
        self.assertEqual(response.data['start_date'], update_data['start_date'])
        self.assertEqual(response.data['capacity'], update_data['capacity'])
        self.assertEqual(response.data['end_time'], update_data['end_time'])
